...
class KeyExtractor:
    ...
    def register_keys(self, packetz):
        ...
        for packet in packetz:
            ...
            if isinstance(self.packetz[packet]["pii_types"], list):
                # print('->',self.packetz[packet]["pii_types"])
                ad = False
                pii = False
    ...
    def make_csv(self,binary_out,list_of_keys,output_path):
        ...
        # print(lok)
        with open(output_path + 'output-small.csv', 'w',encoding="utf-8") as file:
...
rootDir = ""
data_Dir = rootDir + "Research-Nit/antshield_public_dataset/raw_data/auto_anteater/batch1"
out_path = rootDir + "Research-Nit/output/"
